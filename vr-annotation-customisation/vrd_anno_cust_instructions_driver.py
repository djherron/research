...
# this driver script to perform TRAINING set or TEST set VR annotation
# customisations.
...
print('annotation customisation instruction-set names defined')
print()
...
for line_num, line in enumerate(anno_cust_lines):
    ...
    if len(line) == 0 or line == '':  # blank line
        ...
        raise ValueError(f'linetype not recognised in source line {line_num+1}')
