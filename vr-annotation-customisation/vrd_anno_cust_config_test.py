...
step_8_vrd_anno_cust_instructions_file = 'vrd_anno_cust_8_instructions_test.txt'
...
step_11_vrd_anno_cust_instructions_file = 'not defined for TEST set'

step_11_save_customised_annotations = False
